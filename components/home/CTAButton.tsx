...
export default function CTAButton() {
  return (
    <>
      {/* Desktop : Texte + Bouton dans le flux */}
      <div className="hidden lg:flex w-full lg:w-[573px] flex-col justify-start items-center gap-7">
      ...
      {/* Mobile : Texte + Bouton fixés en bas */}
      <div className="lg:hidden fixed bottom-5 left-4 right-4 z-50 flex flex-col items-center gap-3">
        {/* Texte au-dessus du bouton */}
        <div className="text-center">
          <span className="text-zinc-500 text-sm font-medium font-['Satoshi'] leading-5">
            On a trouvé les meilleurs plans
          </span>
          <span className="text-zinc-500 text-sm font-medium font-['Satoshi'] leading-5">
            {' '}pour que ton loyer devienne ton appartement.
